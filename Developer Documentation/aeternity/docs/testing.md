...
We establish this using docker. First read the information on [how to work with our docker images](https://github.com/aeternity/epoch/blob/master/docs/docker.md).
